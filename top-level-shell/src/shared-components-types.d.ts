...
export declare function Table<T extends Record<string, any>>({ columns, data, onRowClick, selectedIds, onSelectionChange, activeRowId, idKey, showCheckboxes, showActions, onActionClick, }: TableProps<T>): import("react/jsx-runtime").JSX.Element;
...
import React from 'react';
declare const ReportsApp: React.FC;
...
import React from 'react';
declare const UserApp: React.FC;
